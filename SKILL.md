---
name: dep-health-checker
description: AI-powered dependency health checker that scans project dependencies for security vulnerabilities and outdated packages. Supports Python (pip), JavaScript (npm), Go (go.mod), Rust (Cargo), and Java (Maven). Generates comprehensive reports in multiple formats (Text, JSON, Markdown, HTML).
author: Claw Tech
version: 1.0.0
tags: [security, dependencies, vulnerability-scanning, devops, automation]
homepage: https://github.com/zhan1206/dep-health-checker
repository: https://github.com/zhan1206/dep-health-checker
topics: [security-scanner, dependency-checker, vulnerability-detection, devops-tool, ci-cd]
license: MIT
languages:
  - Python
min_python_version: "3.8"
required_permissions:
  - network (for OSV API vulnerability checks)
...
configurable_options:
  ...
  - name: format
    ...
    default: "text"
  - name: online
    description: Use online vulnerability database (OSV)
    type: boolean
    default: false
  - name: ignore_dev
